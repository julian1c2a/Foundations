...
|--------|-----------|--------------|--------|
| `Prelim.lean` | `Foundations.Prelim` | — | 🔄 In progress |
...
└── Topic2/                  # (example subdirectory)
    └── Basic.lean
Foundations.lean             # Root module (auto-generated by gen-root.bash)
```
...
```bash
git clone https://github.com/julian1c2a/Foundations.git
cd Foundations
lake build
```
...
| Namespace | `UpperCamelCase` | `Foundations.Topic` |
